...
def _run_one(
    ...
    # Tee this cell's log output to its own file under reports/ and (when tracking) attach
    # it to the child run, exactly as the standard suite does: the SLURM array log holds
    # the only copy otherwise, and no run points to it.
