...
* Write terse, plain, factual docstrings. Add a comment when a part of code isn't obvious to understand. In that case, state what it does and how to use it in as few words as possible. Add at most one short clause of **why**.
